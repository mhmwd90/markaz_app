/*
# Seed demo data — groups, teachers, parents, students, sessions, attendance

Idempotent demonstration data linked to demo accounts created by the bootstrap
...
BEGIN
  ...
  VALUES (p1_id,'Engineer')
  ON CONFLICT (profile_id) DO UPDATE SET occupation=EXCLUDED.occupation
  ...
  WHERE NOT EXISTS (SELECT 1 FROM groups WHERE name='Advanced Memorization')
  ...
  WHERE NOT EXISTS (SELECT 1 FROM groups WHERE name='Revision Circle')
  ...
  WHERE NOT EXISTS (SELECT 1 FROM groups WHERE name='Beginners Group')
  ...
  IF s1 IS NULL THEN
    INSERT INTO students (student_code, full_name, gender, date_of_birth, school, grade, group_id, parent_id, phone_primary, enrollment_date, status)
    VALUES ('STU-1001','Ahmed Al-Rashid','male','2014-03-12','Al-Noor School','Grade 5', g1_id, parent1_id,'+966555000111','2024-09-01','active')
  ...
  IF s2 IS NULL THEN
    INSERT INTO students (student_code, full_name, gender, date_of_birth, school, grade, group_id, parent_id, phone_primary, enrollment_date, status)
    VALUES ('STU-1002','Fatima Al-Zahra','female','2015-07-22','Al-Noor School','Grade 4', g1_id, parent2_id,'+966555000112','2024-09-05','active')
  ...
  IF s3 IS NULL THEN
    INSERT INTO students (student_code, full_name, gender, date_of_birth, school, grade, group_id, parent_id, phone_primary, enrollment_date, status)
    VALUES ('STU-1003','Yusuf Ibn Adam','male','2013-11-30','Dar Al-Huda','Grade 6', g2_id, parent3_id,'+966555000113','2024-08-20','active')
  ...
  IF s4 IS NULL THEN
    INSERT INTO students (student_code, full_name, gender, date_of_birth, school, grade, group_id, parent_id, phone_primary, enrollment_date, status)
    VALUES ('STU-1004','Maryam Al-Siddiqa','female','2015-02-14','Dar Al-Huda','Grade 4', g2_id, parent1_id,'+966555000114','2024-09-10','active')
  ...
  IF s5 IS NULL THEN
    INSERT INTO students (student_code, full_name, gender, date_of_birth, school, grade, group_id, parent_id, phone_primary, enrollment_date, status)
    VALUES ('STU-1005','Ibrahim Al-Mansour','male','2016-05-08','Al-Fajr School','Grade 3', g3_id, parent2_id,'+966555000115','2025-01-10','active')
  ...
  IF s6 IS NULL THEN
    INSERT INTO students (student_code, full_name, gender, date_of_birth, school, grade, group_id, parent_id, phone_primary, enrollment_date, status)
    VALUES ('STU-1006','Khadija Al-Batool','female','2016-09-19','Al-Fajr School','Grade 3', g3_id, parent3_id,'+966555000116','2025-01-12','active')
  ...
  IF s7 IS NULL THEN
    INSERT INTO students (student_code, full_name, gender, date_of_birth, school, grade, group_id, parent_id, phone_primary, enrollment_date, status)
    VALUES ('STU-1007','Omar Al-Farooq','male','2014-12-03','Al-Noor School','Grade 5', g1_id, parent1_id,'+966555000117','2024-09-15','active')
  ...
  IF s8 IS NULL THEN
    INSERT INTO students (student_code, full_name, gender, date_of_birth, school, grade, group_id, parent_id, phone_primary, enrollment_date, status)
    VALUES ('STU-1008','Aisha Al-Tahira','female','2015-04-27','Al-Noor School','Grade 4', g2_id, parent2_id,'+966555000118','2024-09-18','active')
  ...
  IF s9 IS NULL THEN
    INSERT INTO students (student_code, full_name, gender, date_of_birth, school, grade, group_id, parent_id, phone_primary, enrollment_date, status)
    VALUES ('STU-1009','Ali Al-Murtada','male','2013-08-15','Dar Al-Huda','Grade 6', g1_id, parent3_id,'+966555000119','2024-08-25','active')
  ...
  IF s10 IS NULL THEN
    INSERT INTO students (student_code, full_name, gender, date_of_birth, school, grade, group_id, parent_id, phone_primary, enrollment_date, status)
    VALUES ('STU-1010','Hafsa Al-Ansari','female','2016-01-30','Al-Fajr School','Grade 3', g3_id, parent1_id,'+966555000120','2025-01-15','active')
  ...
  IF s11 IS NULL THEN
    INSERT INTO students (student_code, full_name, gender, date_of_birth, school, grade, group_id, parent_id, phone_primary, enrollment_date, status)
    VALUES ('STU-1011','Zayd Al-Harith','male','2014-06-21','Al-Noor School','Grade 5', g2_id, parent2_id,'+966555000121','2024-09-20','active')
  ...
  IF s12 IS NULL THEN
    INSERT INTO students (student_code, full_name, gender, date_of_birth, school, grade, group_id, parent_id, phone_primary, enrollment_date, status)
    VALUES ('STU-1012','Sumayya Al-Ghafara','female','2015-10-11','Dar Al-Huda','Grade 4', g3_id, parent3_id,'+966555000122','2025-01-20','inactive')
  ...
  SELECT s1, g1_id, teacher1_id, CURRENT_DATE - 1, 'present', NULL
  WHERE NOT EXISTS (SELECT 1 FROM attendance WHERE student_id=s1 AND attendance_date=CURRENT_DATE - 1);
  INSERT INTO attendance (student_id, group_id, teacher_id, attendance_date, status, notes)
  SELECT s2, g1_id, teacher1_id, CURRENT_DATE - 1, 'present', NULL
  WHERE NOT EXISTS (SELECT 1 FROM attendance WHERE student_id=s2 AND attendance_date=CURRENT_DATE - 1);
  INSERT INTO attendance (student_id, group_id, teacher_id, attendance_date, status, notes)
  SELECT s7, g1_id, teacher1_id, CURRENT_DATE - 1, 'late', 'Arrived 15 min late'
  WHERE NOT EXISTS (SELECT 1 FROM attendance WHERE student_id=s7 AND attendance_date=CURRENT_DATE - 1);
  INSERT INTO attendance (student_id, group_id, teacher_id, attendance_date, status, notes)
  SELECT s9, g1_id, teacher1_id, CURRENT_DATE - 1, 'absent', 'No notice'
  WHERE NOT EXISTS (SELECT 1 FROM attendance WHERE student_id=s9 AND attendance_date=CURRENT_DATE - 1);
  INSERT INTO attendance (student_id, group_id, teacher_id, attendance_date, status, notes)
  SELECT s3, g2_id, teacher2_id, CURRENT_DATE - 2, 'present', NULL
  WHERE NOT EXISTS (SELECT 1 FROM attendance WHERE student_id=s3 AND attendance_date=CURRENT_DATE - 2);
  INSERT INTO attendance (student_id, group_id, teacher_id, attendance_date, status, notes)
  SELECT s4, g2_id, teacher2_id, CURRENT_DATE - 2, 'excused', 'Medical appointment'
  WHERE NOT EXISTS (SELECT 1 FROM attendance WHERE student_id=s4 AND attendance_date=CURRENT_DATE - 2);
  INSERT INTO attendance (student_id, group_id, teacher_id, attendance_date, status, notes)
  SELECT s8, g2_id, teacher2_id, CURRENT_DATE - 2, 'present', NULL
  WHERE NOT EXISTS (SELECT 1 FROM attendance WHERE student_id=s8 AND attendance_date=CURRENT_DATE - 2);
  INSERT INTO attendance (student_id, group_id, teacher_id, attendance_date, status, notes)
  SELECT s11, g2_id, teacher2_id, CURRENT_DATE - 2, 'present', NULL
  WHERE NOT EXISTS (SELECT 1 FROM attendance WHERE student_id=s11 AND attendance_date=CURRENT_DATE - 2);
  INSERT INTO attendance (student_id, group_id, teacher_id, attendance_date, status, notes)
  SELECT s5, g3_id, teacher3_id, CURRENT_DATE - 1, 'present', NULL
  WHERE NOT EXISTS (SELECT 1 FROM attendance WHERE student_id=s5 AND attendance_date=CURRENT_DATE - 1);
  INSERT INTO attendance (student_id, group_id, teacher_id, attendance_date, status, notes)
  SELECT s6, g3_id, teacher3_id, CURRENT_DATE - 1, 'present', NULL
  WHERE NOT EXISTS (SELECT 1 FROM attendance WHERE student_id=s6 AND attendance_date=CURRENT_DATE - 1);
  INSERT INTO attendance (student_id, group_id, teacher_id, attendance_date, status, notes)
  SELECT s10, g3_id, teacher3_id, CURRENT_DATE - 1, 'excused', 'Family travel'
  WHERE NOT EXISTS (SELECT 1 FROM attendance WHERE student_id=s10 AND attendance_date=CURRENT_DATE - 1);
  ...
  SELECT s1, teacher1_id, CURRENT_DATE - 3, 5, 4, 4, 5, 4, 'Consistent and motivated'
  WHERE NOT EXISTS (SELECT 1 FROM evaluations WHERE student_id=s1 AND evaluation_date=CURRENT_DATE - 3);
  INSERT INTO evaluations (student_id, teacher_id, evaluation_date, tajweed, memorization_quality, revision_quality, behavior, participation, notes)
  SELECT s2, teacher1_id, CURRENT_DATE - 3, 5, 5, 5, 5, 5, 'Excellent all round'
  WHERE NOT EXISTS (SELECT 1 FROM evaluations WHERE student_id=s2 AND evaluation_date=CURRENT_DATE - 3);
  INSERT INTO evaluations (student_id, teacher_id, evaluation_date, tajweed, memorization_quality, revision_quality, behavior, participation, notes)
  SELECT s7, teacher1_id, CURRENT_DATE - 4, 3, 3, 3, 4, 3, 'Can improve with focus'
  WHERE NOT EXISTS (SELECT 1 FROM evaluations WHERE student_id=s7 AND evaluation_date=CURRENT_DATE - 4);
  INSERT INTO evaluations (student_id, teacher_id, evaluation_date, tajweed, memorization_quality, revision_quality, behavior, participation, notes)
  SELECT s3, teacher2_id, CURRENT_DATE - 5, 4, 4, 5, 5, 4, 'Strong revision skills'
  WHERE NOT EXISTS (SELECT 1 FROM evaluations WHERE student_id=s3 AND evaluation_date=CURRENT_DATE - 5);
